...
}' --from $KEY --gas-prices 0.025ujunox --gas "auto" --gas-adjustment 1.5 --yes --output json | jq > infect-init-transfer-juno.log
...
}' --from $KEY --gas-prices 0.025ustars --gas "auto" --gas-adjustment 1.5 --yes --output json | jq > infect-init-transfer-stargaze.log
